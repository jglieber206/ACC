...
#  preview
post '/preview' do
  Struct.new("Preview", :url, :integration, :dd_tags)
  data = JSON.parse request.body.read
  capability = Struct::Preview.new(data["url"], data["integration"], data["dd_tags"])
...
post '/attributes/:attr_id/components/:comp_id' do
  data = JSON.parse request.body.read
  new_capability = Capability.new(name: data['name'], project_id: data['project_id'], code: data['code'], url: data['url'], integration: data['integration'], dd_tags: data['dd_tags'])
  new_capability.save
...
post '/capabilities/update/:id' do
  ...
  capability.update(name: data['name'], code: data['code'], url: data['url'], integration: data['integration'], dd_tags: data['dd_tags'])
  capability.to_json
end
